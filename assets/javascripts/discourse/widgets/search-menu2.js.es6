...
export default createWidget('search-menu2', {
  ...
  panelContents() {
    ...
    const results = [
      this.attach('search-term2', { value: searchData.term, contextEnabled }),
      this.attach('search-context2', {
        contextEnabled,
  ...
  html(attrs) {
    ...
    return this.attach('menu-panel2', { maxWidth: 500, contents: () => this.panelContents() });
  },
